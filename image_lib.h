...
struct Color{
  ...
  Color add(Color rhs){
    float _r = std::min((float)1,r +rhs.r);
    float _g = std::min((float)1,g +rhs.g);
    float _b = std::min((float)1,b +rhs.b);
    return Color(_r,_g,_b);
  }
  Color times(Color rhs){
    float _r = std::min((float)1,r *rhs.r);
    float _g = std::min((float)1,g *rhs.g);
    float _b = std::min((float)1,b *rhs.b);
    return Color(_r,_g,_b);
...
inline Color operator*(Color lhs, float f){
  return lhs.times(Color(f,f,f));
}
